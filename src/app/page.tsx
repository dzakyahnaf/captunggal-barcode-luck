...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-1/4 -left-20 w-72 h-72 rounded-full blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(200,30,40,0.35), transparent)" }} />
      <div className="fixed bottom-1/4 -right-20 w-80 h-80 rounded-full blur-3xl pointer-events-none"
      ...
      <section className="relative z-10 w-full min-h-[100dvh] snap-start flex flex-col items-center justify-center p-6 animate-fade-in-up">
        <div style={{ maxWidth: "420px", display: "flex", flexDirection: "column", alignItems: "center", width: "100%", padding: "0 1.5rem" }}>
          ...
          <div style={{
            ...
            <ol style={{
              ...
              <li>Follow Instagram <strong style={{ color: "#F2F2F2" }}>@rakkencoffee</strong> sebagai syarat untuk berkesempatan memenangkan Free Coffee for a Year.</li>
              <li>Masukkan nama dan nomor WhatsApp aktif untuk ikut berpartisipasi.</li>
          ...
          >
            ...
            <div className="animate-bounce" style={{ filter: "drop-shadow(0 0 8px rgba(252, 211, 77, 0.8))" }}>
              <ChevronDown size={28} />
            </div>
          </div>
      ...
      {/* SECTION 2: Form & CTA */}
      {/* ==================================================== */}
      <section ref={section2Ref} className="relative z-10 w-full min-h-[100dvh] snap-start flex flex-col items-center justify-center p-6">
        <div style={{ maxWidth: "420px", display: "flex", flexDirection: "column", alignItems: "center", width: "100%", padding: "0 1.5rem" }}>
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    opacity: (!phone.trim() || !name.trim() || isLoading) ? 0.6 : 1,
                ...
                >
                  {isLoading ? (
                    <>
                      <div className="spinner" style={{ width: "1.25rem", height: "1.25rem", borderWidth: "2px", borderColor: "#A8131E", borderRightColor: "transparent" }} />
                      <span>Memproses...</span>
                    </>
                  ) : (
                    <>
    ...
    <div style={{
      ...
      <div>
        ...
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.875rem", marginTop: "0.25rem", lineHeight: 1.5 }}>
          Nomor ini sudah pernah mengikuti undian.<br />
          Satu nomor, <strong style={{ color: "#F2F2F2" }}>satu kesempatan</strong>.
        </p>
      </div>
      <a
        href="https://instagram.com/rakkencoffee"
